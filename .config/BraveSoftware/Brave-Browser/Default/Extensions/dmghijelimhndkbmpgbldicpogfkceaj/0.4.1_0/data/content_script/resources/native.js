        ...
        "action": function (rule, sheet) {
          if (rule) {
            if (sheet) {
              ...
              is.outline = rule.style.getPropertyValue("outline-color");
              ...
              is.border = rule.style.getPropertyValue("border-color") || rule.style.getPropertyValue("border-top-color") || rule.style.getPropertyValue("border-bottom-color") || rule.style.getPropertyValue("border-left-color") || rule.style.getPropertyValue("border-right-color");
              /*  */
        ...
        "style": {
          "for": {
            ...
            "shadow": function (rule) {
              if (rule.style) {
                if (rule.style.getPropertyValue("box-shadow")) rule.style.setProperty("box-shadow", "none", rule.style.getPropertyPriority("box-shadow"));
            ...
            "border": function (rule) {
              if (rule.style) {
                var tmp = rule.style.getPropertyValue("outline-color");
                if (tmp) {
                  if (native.dark.engine.is.color.valid.for.border(tmp)) {
                    rule.style.setProperty("outline-color", "#555555", rule.style.getPropertyPriority("outline-color"));
                  }
                }
                /*  */
                var tmp = rule.style.getPropertyValue("border-color");
                if (tmp) {
                  if (native.dark.engine.is.color.valid.for.border(tmp)) {
                    rule.style.setProperty("border-color", "#555555", rule.style.getPropertyPriority("border-color"));
                  }
                }
                /*  */
                var tmp = rule.style.getPropertyValue("border-top-color");
                if (tmp) {
                  if (native.dark.engine.is.color.valid.for.border(tmp)) {
                    rule.style.setProperty("border-top-color", "#555555", rule.style.getPropertyPriority("border-top-color"));
                  }
                }
                /*  */
                var tmp = rule.style.getPropertyValue("border-left-color");
                if (tmp) {
                  if (native.dark.engine.is.color.valid.for.border(tmp)) {
                    rule.style.setProperty("border-left-color", "#555555", rule.style.getPropertyPriority("border-left-color"));
                  }
                }
                /*  */
                var tmp = rule.style.getPropertyValue("border-right-color");
                if (tmp) {
                  if (native.dark.engine.is.color.valid.for.border(tmp)) {
                    rule.style.setProperty("border-right-color", "#555555", rule.style.getPropertyPriority("border-right-color"));
                  }
                }
                /*  */
                var tmp = rule.style.getPropertyValue("border-bottom-color");
                if (tmp) {
                  if (native.dark.engine.is.color.valid.for.border(tmp)) {
                    rule.style.setProperty("border-bottom-color", "#555555", rule.style.getPropertyPriority("border-bottom-color"));
                  }
                }
              }
            }
